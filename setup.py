...
setup(
    ...
    packages=["mee6_graphing_lib"],  # Chose the same as "name"
    ...
    download_url="https://github.com/StarkOdinson612/mee6_graphing_lib/archive/refs/tags/v01.tar.gz",  # I explain this later on
    keywords=[
        "MEE6",
        "Graphing",
        "Discord",
    ...
    install_requires=["mee6-py-api", "matplotlib"],  # I get to this in a second
    classifiers=[
